...
export default function login() {
    return (
        <section className="login-section d-flex justify-content-between align-items-center" style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6),
        rgba(0, 0, 0, 0.6)), url(${Bg})` }}>
            <div className='container y-5'>
                ...
                <div className='w-75 mx-auto py-3 small-para text-white'>
